...
\title{Senior Director of Data Science, Enterprise Model Risk Management}
\location{New York, NY}
\dates{February 2016 -- Present}
\begin{position}

My responsibilities split 75\%/25\% between applied modeling R\&D and serving as a Model Risk Officer (MRO).  In practice,
there is a strong synergy between these two roles, with R\&D work inspired by and feeding into MRO stewardship.  Applied R\&D work will benefit Canadian business as well as US business, and project engagements will be created with the Canadian business whenever appropriate.\\\\
\textbf{\underline{Applied R\&D}}: Explore power of software engineering best practices to streamline and improve model development and validation
\begin{itemize}
    \item Develop methodology and training for applications of automated testing to model development and validation
    \item Research requirements and engage Technology to ensure availability of Python developer infrastructure to Data Science community.
    \item Create software libraries and tools that encode model development best practices, streamline adoption of software engineering techniques, and introduce Data Scientists to open source development methodology.
    \item Be an active contributor to open source and ``inner source'' software projects, such as Yoshi, Zoidberg, and Conrad with the goal of creating useful software and also strengthening working relationships between SMEs on different projects.
\end{itemize}

\textbf{\underline{Model Risk Officer}}
\begin{itemize}
    \item Complete NMRO accreditation in support of Canadian Card models in 2016.
    \item Support roll-out monitoring of CAMARO valuations model.
    \item Support validation of rebuild of Transaction Fraud OTB Hold model.
    \item Support model development validation of TBD behavioral risk models.
\end{itemize}

\textbf{\underline{Recruiting and Mentorship}}
\begin{itemize}
    \item Help revitalize Data Scientist recruiting efforts for Canada Card at McGill university.
    \item Provide mentorship and development guidance to Canada Card Data Scientists.
\end{itemize}
