...
there is a strong synergy between these two roles, with R\&D work inspired by and feeding into MRO stewardship.\\\\
...
\begin{itemize}
    ...
    \item Be an active contributor in inner-source software projects, such as Yoshi, Zoidberg, and Conrad with the goal of creating useful software and also strengthening working relationships between SMEs on different projects.
\end{itemize}
